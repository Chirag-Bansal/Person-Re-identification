...
Original file is located at
    https://colab.research.google.com/drive/1KQgzUSv0gBj3h5rWKaFl7gogBqEVVWPK
"""
...
torch.save(model.state_dict(), 'checkpoint_one.pth')
files.download('checkpoint_one.pth')